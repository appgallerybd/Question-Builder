...
interface AppStore{
 language:AppLanguage; theme:Theme; questions:Question[]; papers:QuestionPaper[]; subjects:Subject[]; drafts:QuestionPaper[]
...
export const useAppStore=create<AppStore>((set,get)=>({
 language:'bn',theme:'light',questions:[],papers:[],subjects:[],drafts:[],
 ...
 hydrate:()=>set({questions:questionRepo.list(),papers:paperRepo.list(),subjects:subjectRepo.list(),drafts:paperRepo.list().filter(p=>p.status==='draft'),language:get().language,theme:get().theme})
}))